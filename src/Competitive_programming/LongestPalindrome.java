...
public class LongestPalindrome {
    ...
    public static void main(String[] args) {
        ...
        while (startPosition < arr.length) {
            ...
            list.addAll(charMap.get(curCh));
            while (list.size() > 0) {
                System.out.println(++stepCount + ". getting last palindromic position of current char: '" + curCh + "' from list: " + list);
...
/**
 Output:
 {a=[0, 1, 2, 4, 5, 6, 7], b=[3]}
 1. getting last palindromic position of current char: 'a' from list: [0, 1, 2, 4, 5, 6, 7]
 2. getting last palindromic position of current char: 'a' from list: [0, 1, 2, 4, 5, 6]
 found larger palindrome from 0 to 6
 3. getting last palindromic position of current char: 'a' from list: [0, 1, 2, 4, 5, 6, 7]
 4. getting last palindromic position of current char: 'a' from list: [0, 1, 2, 4, 5, 6]
 breaking as no longer palindrome possible
 breaking as no longer palindrome possible
 Largest palindrome: aaabaaa
 */